...
class AIAnalyzer:
    ...
    def _client(self):
        ...
        if self.client is None:
            ...
            if not api_key:
                console.print("[red]Error: OpenAI API key not set. Please set it using one of the following methods:[/red]")
                console.print("1. Use --api-key command line argument")
                console.print("2. Set api_key in the .aicmtrc configuration file")
    ...
    def analyze_changes(self, changes: list) -> List[Dict]:
        ...
        try:
            ...
            try:
                ...
                raise ValueError(f"Format failed: API returned invalid JSON format: {str(je)}")
